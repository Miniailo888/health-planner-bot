require('./server'); // запускаємо веб-сервер разом із ботом
...
bot.command('app', (ctx) => {
  ctx.reply('Відкрий свій планувальник:', mainMenu(WEB_APP_URL));
});
...
bot.launch().then(() => {
  ...
  console.log('💡 Для публічного доступу запусти: npx ngrok http 3000');
});
